...
var Path = {
  ...
  equals(path3, another) {
    return path3.length === another.length && path3.every((n2, i2) => n2 === another[i2]);
  },
  hasPrevious(path3) {
...
var normalizeNode = (editor, entry) => {
  ...
  var n2 = 0;
  for (var i2 = 0; i2 < node3.children.length; i2++, n2++) {
  ...
  for (var [node3, path3] of Editor.nodes(editor, {
    ...
    if (Element.isElement(node3)) {
      ...
      if (Editor.hasInlines(editor, node3)) {
        ...
        var s2 = Path.isAncestor(path3, start2.path) ? start2 : Editor.start(editor, path3);
...
var insertFragment = function insertFragment2(editor, fragment2) {
  ...
  Editor.withoutNormalizing(editor, () => {
    ...
    Transforms.splitNodes(editor, {
      at,
      match: (n2) => hasBlocks2 ? Element.isElement(n2) && Editor.isBlock(editor, n2) : Text.isText(n2) || Editor.isInline(editor, n2),
    ...
    for (var [node3, path3] of Editor.nodes(editor, {
      ...
      for (var k2 in props) {
        ...
        if (compare(props[k2], node3[k2])) {
          ...
          if (merge) {
            if (props[k2] != null)
              newProperties[k2] = merge(node3[k2], props[k2]);
          } else {
            if (props[k2] != null)
  ...
  Editor.withoutNormalizing(editor, () => {
    ...
    var _loop = function _loop2(pathRef4) {
      ...
      Transforms.liftNodes(editor, {
        at: range2,
        match: (n2) => Element.isAncestor(node3) && node3.children.includes(n2),
        voids
      });
    };
    for (var pathRef3 of pathRefs2) {
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-4T4PF4QL.js.map
